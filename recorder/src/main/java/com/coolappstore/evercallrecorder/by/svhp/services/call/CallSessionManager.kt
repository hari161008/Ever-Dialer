...
import com.coolappstore.evercallrecorder.by.svhp.utils.PhoneNumberManager.Companion.normalisePhoneNumber
...
class CallSessionManager private constructor(context: Context) {
    ...
    companion object {
        ...
        const val ACTION_DEBUG_IDLE     = "com.coolappstore.evercallrecorder.by.svhp.action.DEBUG_IDLE"
        const val ACTION_DEBUG_RINGING  = "com.coolappstore.evercallrecorder.by.svhp.action.DEBUG_RINGING"
        const val ACTION_DEBUG_OFFHOOK  = "com.coolappstore.evercallrecorder.by.svhp.action.DEBUG_OFFHOOK"
    }
