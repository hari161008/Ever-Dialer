...
class RecordingForegroundService : Service() {
    companion object {
        ...
        const val ACTION_START_RECORDING = "com.coolappstore.evercallrecorder.by.svhp.START_RECORDING"
        ...
        const val ACTION_PAUSE_RECORDING = "com.coolappstore.evercallrecorder.by.svhp.PAUSE_RECORDING"

        /** Intent action sent to this service to resume the current recording. */
        const val ACTION_RESUME_RECORDING = "com.coolappstore.evercallrecorder.by.svhp.RESUME_RECORDING"


        /**
         * Intent action sent by the standby notification's "Record" button.
         */
        const val ACTION_MANUAL_START = "com.coolappstore.evercallrecorder.by.svhp.MANUAL_START_RECORDING"

        /** Intent action sent to this service when the user dismisses the notification (Android 14+). */
        const val ACTION_NOTIFICATION_DISMISSED = "com.coolappstore.evercallrecorder.by.svhp.SERVICE_NOTIFICATION_DISMISSED"
    }
