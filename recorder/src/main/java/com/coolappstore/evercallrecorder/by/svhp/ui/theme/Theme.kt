...
private fun buildLightScheme(hue: Float) = lightColorScheme(
    ...
    onPrimary           = White,
    primaryContainer    = colorFromHsv(hue, 0.25f, 0.94f),
    onPrimaryContainer  = colorFromHsv(hue, 0.80f, 0.24f),
    secondary           = colorFromHsv(hue, 0.40f, 0.42f),
    onSecondary         = White,
    secondaryContainer  = colorFromHsv(hue, 0.20f, 0.90f),
    onSecondaryContainer= colorFromHsv(hue, 0.55f, 0.18f),
    tertiary            = colorFromHsv((hue + 40f) % 360f, 0.55f, 0.40f),
    onTertiary          = White,
    tertiaryContainer   = colorFromHsv((hue + 40f) % 360f, 0.22f, 0.92f),
    onTertiaryContainer = colorFromHsv((hue + 40f) % 360f, 0.55f, 0.22f),
    surface             = colorFromHsv(hue, 0.05f, 0.98f),
    onSurface           = NearBlackText,
    surfaceContainerLowest = White,
    surfaceContainerLow = colorFromHsv(hue, 0.08f, 0.95f),
    surfaceContainer    = colorFromHsv(hue, 0.10f, 0.92f),
    surfaceContainerHigh= colorFromHsv(hue, 0.12f, 0.88f),
    surfaceContainerHighest = colorFromHsv(hue, 0.14f, 0.84f),
    surfaceVariant      = colorFromHsv(hue, 0.12f, 0.88f),
    onSurfaceVariant    = colorFromHsv(hue, 0.35f, 0.30f),
    background          = colorFromHsv(hue, 0.05f, 0.98f),
    onBackground        = NearBlackText,
    outline             = colorFromHsv(hue, 0.20f, 0.55f),
    outlineVariant      = colorFromHsv(hue, 0.15f, 0.80f)
)

private fun buildDarkScheme(hue: Float) = darkColorScheme(
    primary             = colorFromHsv(hue, 0.40f, 0.85f),
    onPrimary           = colorFromHsv(hue, 0.80f, 0.20f),
    primaryContainer    = colorFromHsv(hue, 0.60f, 0.32f),
    onPrimaryContainer  = colorFromHsv(hue, 0.22f, 0.94f),
    secondary           = colorFromHsv(hue, 0.28f, 0.80f),
    onSecondary         = colorFromHsv(hue, 0.50f, 0.18f),
    secondaryContainer  = colorFromHsv(hue, 0.35f, 0.30f),
    onSecondaryContainer= colorFromHsv(hue, 0.18f, 0.88f),
    tertiary            = colorFromHsv((hue + 40f) % 360f, 0.30f, 0.82f),
    onTertiary          = colorFromHsv((hue + 40f) % 360f, 0.75f, 0.20f),
    tertiaryContainer   = colorFromHsv((hue + 40f) % 360f, 0.50f, 0.30f),
    onTertiaryContainer = colorFromHsv((hue + 40f) % 360f, 0.18f, 0.88f),
    surface             = colorFromHsv(hue, 0.10f, 0.08f),
    onSurface           = OffWhiteText,
    surfaceContainerLowest = colorFromHsv(hue, 0.10f, 0.05f),
    surfaceContainerLow = colorFromHsv(hue, 0.14f, 0.10f),
    surfaceContainer    = colorFromHsv(hue, 0.16f, 0.14f),
    surfaceContainerHigh= colorFromHsv(hue, 0.18f, 0.18f),
    surfaceContainerHighest = colorFromHsv(hue, 0.20f, 0.22f),
    surfaceVariant      = colorFromHsv(hue, 0.20f, 0.22f),
    onSurfaceVariant    = colorFromHsv(hue, 0.15f, 0.80f),
    background          = colorFromHsv(hue, 0.10f, 0.08f),
    onBackground        = OffWhiteText,
    outline             = colorFromHsv(hue, 0.20f, 0.58f),
    outlineVariant      = colorFromHsv(hue, 0.20f, 0.28f)
)
